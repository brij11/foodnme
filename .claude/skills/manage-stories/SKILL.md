---
name: manage-stories
description: Create and maintain a modular agile-stories tree under `stories/`. First run bootstraps from the blueprint; subsequent runs support add / split / update / lint / index. Enforces size cap (≤5 SP), owner assignment, dependency tracking, design linkage, and tech-feasibility against TECHNICAL-REQUIREMENTS.md.
---
